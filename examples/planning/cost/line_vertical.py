"""Vertical-line cost: the gripper is encouraged to move up and down.

Soft counterpart to ``constrained/line_vertical.py``.  The residual —
TCP's ``x`` and ``y`` pinned, first two columns of the gripper
rotation pinned — is turned into a scalar quadratic penalty
