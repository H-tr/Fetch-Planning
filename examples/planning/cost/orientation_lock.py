...
Soft counterpart to ``constrained/orientation_lock.py``.  The
six-element residual that pins the first two columns of the gripper
rotation matrix is squared and summed into a scalar cost.  The
planner is free to wiggle the gripper orientation mid-path, but any
deviation pays a quadratic penalty integrated along the motion —
