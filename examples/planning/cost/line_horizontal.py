"""Line cost: the gripper is *encouraged* to ride a horizontal rail.

Soft counterpart to ``constrained/line_horizontal.py``.  Same
residual — TCP's ``y`` and ``z`` pinned, first two columns of the
gripper rotation pinned — but here it feeds a scalar cost
