"""Line constraint: the gripper rides a horizontal rail.
...
flipping or rolling.  The residual has rank 5 on the 7-DOF
...
from fetch_planning.planning import Constraint, create_planner
