...
# IKFast backend (Fetch-specific, ships compiled ikfast_fetch module).
try:
    from .ikfast_solver import IKFastSolver

    __all__ += ["IKFastSolver"]
except ModuleNotFoundError:
    # ikfast_fetch C extension not built — IKFastSolver unavailable.
    pass
